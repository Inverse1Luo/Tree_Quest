...
abstract public class EventListenerManager implements ActionListener, MouseListener, MouseWheelListener, MouseMotionListener {
	...
	public void addMouseEvent(Component component, String componentName){
		component.addMouseListener(this);
		component.addMouseWheelListener(this);
		component.addMouseMotionListener(this);
	...
	public void removeMouseEvent(Component component){
